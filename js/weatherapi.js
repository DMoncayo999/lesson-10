...
const weatherAPI = `//api.openweathermap.org/data/2.5/weather?id=${cityId}&units=imperial&APPID=${apiKey}`;
const forecastAPI = `//api.openweathermap.org/data/2.5/forecast?id=${cityId}&units=imperial&APPID=${apiKey}`;
